About pygments-cache-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pygments-cache-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4565&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pygments-cache-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pygments-cache` can be installed with `conda`:
...
```
mamba install pygments-cache
```

It is possible to list all of the versions of `pygments-cache` available on your platform with `conda`:
...
```
mamba search pygments-cache --channel conda-forge
```
...
mamba repoquery search pygments-cache --channel conda-forge

# List packages depending on `pygments-cache`:
mamba repoquery whoneeds pygments-cache --channel conda-forge

# List dependencies of `pygments-cache`:
mamba repoquery depends pygments-cache --channel conda-forge
```
